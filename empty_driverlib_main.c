...
//       if(m>0)
//       {
//          SCI_writeCharArray(mySCI0_BASE, (uint16_t *)("SPEED RMFR="), sizeof("SPEED RMFR="));
//            intToStrPositive(m, l);
//            SCI_writeCharArray(mySCI0_BASE, (uint16_t *)l, sizeof(l));
//            SCI_writeCharArray(mySCI0_BASE, (uint16_t *)("\r\n"), sizeof("\r\n"));
//       }
//        uint16_t k=posSpeed.speedRPMPR;
//        char p[16]={};
//        if(k>0)
//        {
//            SCI_writeCharArray(mySCI0_BASE, (uint16_t *)("SPEED RMPR="), sizeof("SPEED RMPR="));
//         intToStrPositive(k, p);
//         SCI_writeCharArray(mySCI0_BASE, (uint16_t *)p, sizeof(p));
//         SCI_writeCharArray(mySCI0_BASE, (uint16_t *)("\r\n"), sizeof("\r\n"));
//        }
